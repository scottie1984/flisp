  ...
  describe('interpret', function() {
    ...
    describe('invocation', function() {
      ...
      it('should return first element of list', function() {
        expect(t.interpret(t.parse("(head (1 2 3))"))).toEqual(1);
      });

      it('should return rest of list', function() {
        expect(t.interpret(t.parse("(tail (1 2 3))"))).toEqual([2, 3]);
      });
    });

    describe('lambdas', function() {
      it('should return correct result when invoke lambda w no params', function() {
        expect(t.interpret(t.parse("((lambda () (tail (1 2))))"))).toEqual([2]);
      });
      ...
      it('should return correct result when invoke lambda w params', function() {
        expect(t.interpret(t.parse("((lambda (x) (head (x))) 1)")))
          .toEqual(1);
      });
    });
    ...
    describe('add', function() {
	  it('should add 2 numbers', function() {
		expect(t.interpret(t.parse("(add 1.3 1.5)"))).toEqual(2.8);
		expect(t.interpret(t.parse("(add 3 5)"))).toEqual(8);
	  });
	});
