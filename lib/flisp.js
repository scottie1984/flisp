...
let propInObject = R.flip(R.prop);

function Context(scope, parent) {

	let get = R.cond([
	   [propInObject(library), propInObject(library)],
	   [propInObject(scope), propInObject(scope)],
	   [R.T, identifier => parent && parent.get(identifier)]
	]);
